...
{
    static class VoxelBlueprintWeaponPartBoxCutGizmo
    {
        ...
        public static void DrawBoxes(
            PreviewRenderUtility preview, VoxelBlueprintWeaponPartBoxCut cut, int selected,
            bool onlySelected, Vector3 gridCenter, Mesh cube, Material material, VoxelBlueprintPartBoxTool tool)
        {
            ...
            for (int i = 0; i < cut.PartCount; i++)
            {
                ...
                box.EnsureOriented();
                Color color = VoxelBlueprintWeaponPartBoxCutWindow.ColorOf(i);
                if (i != selected)
                    color.a = 0.35f;
        ...
        static void DrawSelectedHandles(
            PreviewRenderUtility preview, VoxelBlueprintWeaponPartBoxCut.Box box, Vector3 gridCenter,
        ...
        public static bool TryHandle(
            Rect rect, Camera camera, ref VoxelBlueprintWeaponPartBoxCut.Box box, Vector3 gridCenter,
        ...
        public static int HitOtherBox(
            Rect rect, Camera camera, VoxelBlueprintWeaponPartBoxCut cut, int selected, Vector3 gridCenter)
        {
            Event e = Event.current;
        ...
        public static void NudgeMove(ref VoxelBlueprintWeaponPartBoxCut.Box box, Vector3 worldStep)
        {
            box.EnsureOriented();
            box.center += worldStep;
        }

        public static void NudgeScale(ref VoxelBlueprintWeaponPartBoxCut.Box box, Vector3 worldDir, float delta)
        {
            box.EnsureOriented();
        ...
        static void ApplyFaceScale(ref VoxelBlueprintWeaponPartBoxCut.Box box, int face, float delta)
        {
